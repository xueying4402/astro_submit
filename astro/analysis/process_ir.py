...
VARIBLE_TYPES = ['StateVariableSolc', 'StateVariable', 'LocalVariableSolc', 'LocalVariable']
...
def get_state_var_obj(log, var):
    if var in SDG.map_svars_to_sobj.keys():
        ...
        if DEBUG:
            if not config.get_scale():  log.info("This should be implemented, this is for structures!")
            sys.exit(1)
        else:
            pass
...
def process_left_or_right_variable(log, vrg, variable, cfg_obj, call_type, instr, parameters=[], parent=None, node=None, graph=None):
    ...
    if type(variable).__name__ == 'TemporaryVariable':
        ...
        if type(variable).__name__ == 'StateVariableSolc' or type(variable).__name__ == 'StateVariable':
        ...
        elif type(variable).__name__ == 'LocalVariableSolc' or type(variable).__name__ == 'LocalVariable':
...
def process_index_ir(log, vrg, instr, variable, cfg_obj, call_type, parent=None):
    ...
    if lvalue not in vrg._ref_to_state.keys():
        if type(variable_left).__name__ == 'StateVariableSolc' or type(variable_left).__name__ == 'StateVariable':
        ...
        elif type(variable_left).__name__ == 'LocalVariableSolc' or type(variable_left).__name__ == 'LocalVariable':
            ...
            if type(state_var).__name__ == 'StateVariableSolc' or type(state_var).__name__ == 'StateVariable':
...
def process_member_ir(log, vrg, instr, variable, cfg_obj, call_type, parent):
    ...
    if lvalue not in vrg._ref_to_state.keys():
        ...
        elif type(var_left).__name__ == 'LocalVariableSolc' or type(var_left).__name__ == 'LocalVariable':
...
def process_balance_ir(log, vrg, instr, variable, cfg_obj, call_type, parent=None):
    ...
    elif type(instr.value).__name__ == 'StateVariableSolc' or type(instr.value).__name__ == 'StateVariable':
        lvalue = instr.lvalue
    ...
    elif type(instr.value).__name__ == 'LocalVariableSolc' or type(instr.value).__name__ == 'LocalVariable':
        lvalue = instr.lvalue
...
def process_length_ir(log, vrg, instr, variable, cfg_obj, call_type, parent=None):
    ...
    if type(instr.value).__name__ == 'StateVariableSolc' or type(instr.value).__name__ == 'StateVariable':
    ...
    if isinstance(function_return, list):
        for element in function_return:
            if element in function_parameters:
                ...
                elif type(element).__name__ == 'StateVariableSolc' or type(element).__name__ == 'StateVariable':
                ...
                elif type(element).__name__ == 'LocalVariableSolc' or type(element).__name__ == 'LocalVariable':
        ...
        elif type(function_return).__name__ == 'StateVariableSolc' or type(function_return).__name__ == 'StateVariable':
...
def get_call_arguments_origin(log, vrg, argument, call_instr, caller_parameters, caller_cfg_obj, call_type, parent=None):
    ...
    if isinstance(argument, list):
        ...
        elif type(argument).__name__ == 'StateVariableSolc' or type(argument).__name__ == 'StateVariable':
            origin_res = [argument]
        ...
        elif type(argument).__name__ == 'LocalVariableSolc' or type(argument).__name__ == 'LocalVariable':
