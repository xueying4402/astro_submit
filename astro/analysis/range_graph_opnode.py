...
VARIABLE_TYPES = ['StateVariableSolc', 'StateVariable', 'LocalVariableSolc', 'LocalVariable']
DESIRABLE_TYPES = ['StateVariableSolc', 'StateVariable', 'int', 'Constant', 'str']
...
class VRG:
    ...
    def process_variable_left(self, var_left, cfg_obj, instr, parameters=[], parent=None, node=None, graph=None):
        ...
        if type(var_left).__name__ == 'TemporaryVariable':
            ...
            if type(var_left).__name__ == 'LocalVariableSolc' or type(var_left).__name__ == 'LocalVariable':
    ...
    def process_variable_right(self, var_right, cfg_obj, instr, parameters=[], parent=None, node=None, graph=None):
        ...
        if type(var_right).__name__ == 'TemporaryVariable':
            ...
            if type(var_right).__name__ == 'StateVariableSolc' or type(var_right).__name__ == 'StateVariable':
            ...
            if type(var_right).__name__ == 'LocalVariableSolc' or type(var_right).__name__ == 'LocalVariable':
    ...
    def map_callee_returns_to_caller_args(self, callee_function, call_arguments):
        ...
        for return_key in function_returns.keys():
            ...
            if isinstance(function_return, OpNode):
                ...
                elif type(function_return) == 'StateVariableSolc' or type(function_return) == 'StateVariable':
    ...
    def get_origin_variable_from_refvariable(self, instruction, variable, cfg_obj):
        ...
        for instr in instrs:
            if type(instr).__name__ == 'Index':
                ...
                elif type(instr.variable_left).__name__ == 'LocalVariableSolc' or type(instr.variable_left).__name__ == 'LocalVariable':
                    self._ref_to_state[instr.lvalue] = instr.variable_left
                    return instr.variable_left
